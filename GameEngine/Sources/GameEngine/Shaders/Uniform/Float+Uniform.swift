...
extension Float: UniformType, UniformComponent {
    ...
    static func bind(_ val: SIMD2<Float>, uniform location: Int32) {
        c_glUniform2f(location, val.x, val.y)
    }

    static func bind(_ val: SIMD3<Float>, uniform location: Int32) {
        c_glUniform3f(location, val.x, val.y, val.z)
    }

    static func bind(_ val: SIMD4<Float>, uniform location: Int32) {
