...
extension Vertex {
    ...
    fileprivate static let cubeVerticiesAndIndexes: ([Vertex], [UInt32]) = (
        [
            Vertex(coords: .init(x: -0.5, y: -0.5, z: -0.5), color: .coral, texture: .init(0.0, 0.0)), // 0 - Bottom-left-back
            Vertex(coords: .init(x:  0.5, y: -0.5, z: -0.5), color: .coral, texture: .init(1.0, 0.0)), // 1 - Bottom-right-back
            Vertex(coords: .init(x:  0.5, y:  0.5, z: -0.5), color: .coral, texture: .init(1.0, 1.0)), // 2 - Top-right-back
            ...
            Vertex(coords: .init(x:  0.5, y:  0.5, z:  0.5), color: .coral, texture: .init(1.0, 1.0)), // 6 - Top-right-front
